...
standards profiling organization has developed a collection of profiles which can be
leveraged for use by healthcare communities for the purposes of document
sharing.  The purpose of this white paper is to provide an overview of the collection of IHE integration profiles
